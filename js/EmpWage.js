...
window.addEventListener("DOMContentLoaded", (event) => {
    ...
    EMP_ID.addEventListener("input", function() {
      if(EMP_ID.value.length == 0) {
          setTextValue(".text-error", "");
          return;
      }
      try {
          (new EmployeePayRoll()).EMP_ID = EMP_ID.value;
          setTextValue(".text-error", "");
      } catch (e) {
          setTextValue(".text-error", e);
      }
    ...
    name.addEventListener("input", function() {
        ...
        try {
            (new EmployeePayRoll()).Email = Email.value;
            setTextValue(".text-error", "");
        } catch (e) {
            setTextValue(".text-error", e);
        }
...
const setEmployeePayrollObject = () => {
    ...
    employeePayrollObj._EMP_ID = getInputValueById("#EMP_ID")
    ...
    employeePayrollObj._Email = getInputValueById("#Email");
}
function createAndUpdateStorage() {
  ...
  const setEmployeePayrollData = (employeePayrollData) => {
    ...
    try {
      employeePayrollData.EMP_ID = employeePayrollObj._EMP_ID;
    } catch (e) {
      setTextValue(".name-error", e);
      throw e;
    }
    ...
    employeePayrollData.Email = employeePayrollObj._Email;
  ...
  const setForm = () => {
    ...
    setValue("#Email", employeePayrollObj._Email);
